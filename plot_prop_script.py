...
for audit in data['audits']:
    ...
    new_method_props.append(new_method_round_size / suite_r2bravo_round_size)
...
ax.plot(fractional_margins, new_method_props, color='b', marker='o', label='New Method Round Size as a Proportion of the SUITE R2 Bravo Round Size(Sick Math)')
ax.set_xlabel('Fractional Margin', fontsize=20)
ax.set_ylabel('First Round Size as Proportion (achieves 90% stopping probability)', fontsize=20)
